<template>
  ...
  >
    ...
    <div class="orders-item-right">
      <div
        class="orders-item-state"
        :class="'orders-item-state-' + order.order_status.id"
        v-if="order.order_status.id === 1"
      >
...
import { packageStore, setOrder } from "../../store/package";

const props = defineProps(["order"]);

const getIsSelected = computed(() => props.order.id === packageStore.order?.id);
